...
public class TestaAviao {
    public static void main(String[] args) {
        ...
        // Veiculo{registro=null, modelo=737, marca=boing,
        // quilometragem=0}Aviao{finalidade=CARGA}

        // Aviao av2 = new Aviao(p1, "", "boing", Finalidade.CARGA);
        // System.out.println(av2);
        // Exception in thread "main" java.lang.IllegalArgumentException: O modelo nao
        ...
        // Exception in thread "main" java.lang.IllegalArgumentException: A marca nao
        ...
        // System.out.println(av1);
        // Veiculo{registro=Registro{numero=1000, local=POA, data=29/4/2025},
        // modelo=737, marca=boing, quilometragem=0}Aviao{finalidade=CARGA}

        // Aviao av2 = new Aviao(p1, "737", "boing", Finalidade.CARGA);
        // av2.setRegistro(null);
        // Exception in thread "main" java.lang.IllegalArgumentException: O registro nao
        // pode ser nulo
        ...
        // System.out.println(av1);
        // // Veiculo{registro=Registro{numero=1000, local=POA, data=29/4/2025},
        // modelo=737, marca=boing, quilometragem=0,
        // proprietarioPrincipal=Proprietario{nome=Ana,
        // cpf=6789-22}}Aviao{finalidade=CARGA
        //
        ...
        // System.out.println("Adicionou Ana novamente ? " + av1.addProprietario(p2));
        // //false
        // System.out.println("Adicionou Luiz ? " + av1.addProprietario(new Pessoa
        // ("Luiz", "6543-77"))); //true
        // System.out.println("Adicionou Pedro ? " + av1.addProprietario(new Pessoa
        // ("Pedro", "2468-11"))); //false
        //
        ...
        // }
        //
        // System.out.println("Luiz eh proprietario do aviao ?" + av1.pertence(new
        // Pessoa ("Luiz", "6543-77"))) ; //true
        // System.out.println("Pedro eh proprietario do aviao ?" + av1.pertence(new
        // Pessoa ("Pedro", "2468-11"))) ; //false
        ...
        // System.out.println("O aviao esta transportando " + av1.getConteudo()); //O
        // aviao esta transportando mercadorias
        //
        // av1.setFinalidade(Finalidade.PASSAGEIRO);
        // System.out.println("O aviao esta transportando " + av1.getConteudo()); //O
        // aviao esta transportando passageiros
        //
        // av1.setFinalidade(Finalidade.AGRICOLA);
        // Exception in thread "main" java.lang.IllegalArgumentException: Aviao nao pode
        // mudar de finalidade
